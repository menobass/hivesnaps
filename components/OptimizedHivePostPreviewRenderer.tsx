...
export const OptimizedHivePostPreviewRenderer: React.FC<OptimizedHivePostPreviewRendererProps> =
  React.memo(
    ({ postUrls, colors, onError }) => {
          ...
          if (urlsToFetch.length > 0) {
            ...
            try {
              ...
              urlsToFetch.forEach(url => {
                ...
                if (parsed) {
                  hivePostPreviewCache.setLoading(
                    url,
                    fetchPromise.then(
                      results =>
                        results.find(
              ...
              urlsToFetch.forEach(url => {
                hivePostPreviewCache.setCachedPostInfo(
                  url,
                  null,
...
OptimizedHivePostPreviewRenderer.displayName =
