...
import { HivePostInfo, extractHivePostUrls } from '../utils/extractHivePostInfo';
...
export const ContextHivePostPreviewRenderer: React.FC<ContextHivePostPreviewRendererProps> = React.memo(({ 
  text, 
  colors 
}) => {
