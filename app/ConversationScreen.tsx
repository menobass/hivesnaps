...
const ConversationScreenRefactored = () => {
  ...
  // Function to render a single reply (no recursion)
  const renderSingleReply = (reply: ReplyData & { visualLevel: number }) => {
    ...
    console.log(`[FLAT] Rendering reply from ${reply.author}, visualLevel: ${visualLevel}, marginLeft: ${marginLeft}px`);
